...
for n=1:4
    eval(['[linear_tr' num2str(n) ', boundary, alpha_tr' num2str(n) ', beta_tr' num2str(n) '] = trainKFMCP3(tr' num2str(n) ',fms' num2str(n) ',C1,C2,''linear'',[]);']);
    eval(['[predicty_linear_tr' num2str(n) ', predict_linear_tr' num2str(n) '] = testKFMCP3(linear_tr' num2str(n) ',boundary, tr' num2str(n) ',tr' num2str(n) ',''linear'',[]);']);
    outputtable(2*n,1) = {['predict_linear_tr' num2str(n)]};
    outputtable(2*n,2:19) = num2cell(eval(['predict_linear_tr' num2str(n) '(:,1:18)']));
    eval(['[predicty_linear_ts' num2str(n) ', predict_linear_ts' num2str(n) '] = testKFMCP3(linear_tr' num2str(n) ',boundary, tr' num2str(n) ',testset,''linear'',[]);']);
...
for n=1:10
    eval(['[poly_tr' num2str(n) ', boundary, alpha_tr' num2str(n) ', beta_tr' num2str(n) '] = trainKFMCP3(tr' num2str(n) ',fms' num2str(n) ',C1,C2,''poly'',polykp);']);
    eval(['[predicty_poly_tr' num2str(n) ', predict_poly_tr' num2str(n) '] = testKFMCP3(poly_tr' num2str(n) ',boundary, tr' num2str(n) ',tr' num2str(n) ',''poly'',polykp);']);
    outputtable(2*n,1) = {['predict_poly_tr' num2str(n)]};
    outputtable(2*n,2:19) = num2cell(eval(['predict_poly_tr' num2str(n) '(:,1:18)']));
    eval(['[predicty_poly_ts' num2str(n) ', predict_poly_ts' num2str(n) '] = testKFMCP3(poly_tr' num2str(n) ',boundary, tr' num2str(n) ',testset,''poly'',polykp);']);
...
for n=1:10
    eval(['[gauss_tr' num2str(n) ', boundary, alpha_tr' num2str(n) ', beta_tr' num2str(n) '] = trainKFMCP3(tr' num2str(n) ',fms' num2str(n) ',C1,C2,''gauss'',gausskp);']);
    eval(['[predicty_gauss_tr' num2str(n) ', predict_gauss_tr' num2str(n) '] = testKFMCP3(gauss_tr' num2str(n) ',boundary, tr' num2str(n) ',tr' num2str(n) ',''gauss'',gausskp);']);
    outputtable(2*n,1) = {['predict_gauss_tr' num2str(n)]};
    outputtable(2*n,2:19) = num2cell(eval(['predict_gauss_tr' num2str(n) '(:,1:18)']));
    eval(['[predicty_gauss_ts' num2str(n) ', predict_gauss_ts' num2str(n) '] = testKFMCP3(gauss_tr' num2str(n) ',boundary, tr' num2str(n) ',testset,''gauss'',gausskp);']);
    outputtable(2*n+1,1) = {['predict_gauss_ts' num2str(n)]};
    outputtable(2*n+1,2:19) = num2cell(eval(['predict_gauss_ts' num2str(n) '(:,1:18)']));
end

xlswrite('D:\KFMCPwithMatlab2\results20120123\outputKFMCPforAus1401.xls',outputtable,'sheet3','A1');
...
for n=1:10
    eval(['[sigm_tr' num2str(n) ', boundary, alpha_tr' num2str(n) ', beta_tr' num2str(n) '] = trainKFMCP3(tr' num2str(n) ',fms' num2str(n) ',C1,C2,''sigm'',sigmkp);']);
    eval(['[predicty_sigm_tr' num2str(n) ', predict_sigm_tr' num2str(n) '] = testKFMCP3(sigm_tr' num2str(n) ',boundary, tr' num2str(n) ',tr' num2str(n) ',''sigm'',sigmkp);']);
    outputtable(2*n,1) = {['predict_sigm_tr' num2str(n)]};
    outputtable(2*n,2:19) = num2cell(eval(['predict_sigm_tr' num2str(n) '(:,1:18)']));
    eval(['[predicty_sigm_ts' num2str(n) ', predict_sigm_ts' num2str(n) '] = testKFMCP3(sigm_tr' num2str(n) ',boundary, tr' num2str(n) ',testset,''sigm'',sigmkp);']);
...
for n=1:5
    eval(['[linear_tr' num2str(n) ', boundary, alpha_tr' num2str(n) ', beta_tr' num2str(n) '] = trainKFMCP3(tr' num2str(n) ',fms' num2str(n) ',5,13,''linear'',[]);']);
    eval(['[predicty_linear_tr' num2str(n) ', predict_linear_tr' num2str(n) '] = testKFMCP3(linear_tr' num2str(n) ',boundary, tr' num2str(n) ',tr' num2str(n) ',''linear'',[]);']);
    outputtable(2*n,1) = {['predict_linear_tr' num2str(n)]};
    outputtable(2*n,2:19) = num2cell(eval(['predict_linear_tr' num2str(n) '(:,1:18)']));
    eval(['[predicty_linear_ts' num2str(n) ', predict_linear_ts' num2str(n) '] = testKFMCP3(linear_tr' num2str(n) ',boundary, tr' num2str(n) ',testset,''linear'',[]);']);
...
for n=1:5
    eval(['[poly_tr' num2str(n) ', boundary, alpha_tr' num2str(n) ', beta_tr' num2str(n) '] = trainKFMCP3(tr' num2str(n) ',fms' num2str(n) ',5,13,''poly'',[1,2]);']);
    eval(['[predicty_poly_tr' num2str(n) ', predict_poly_tr' num2str(n) '] = testKFMCP3(poly_tr' num2str(n) ',boundary, tr' num2str(n) ',tr' num2str(n) ',''poly'',[1,2]);']);
    outputtable(2*n,1) = {['predict_linear_tr' num2str(n)]};
    outputtable(2*n,2:19) = num2cell(eval(['predict_poly_tr' num2str(n) '(:,1:18)']));
    eval(['[predicty_poly_ts' num2str(n) ', predict_poly_ts' num2str(n) '] = testKFMCP3(poly_tr' num2str(n) ',boundary, tr' num2str(n) ',testset,''poly'',[1,2]);']);
    outputtable(2*n+1,1) = {['predict_poly_ts' num2str(n)]};
    outputtable(2*n+1,2:19) = num2cell(eval(['predict_poly_ts' num2str(n) '(:,1:18)']));
end
...
for n=1:5
    eval(['[gauss_tr' num2str(n) ', boundary, alpha_tr' num2str(n) ', beta_tr' num2str(n) '] = trainKFMCP3(tr' num2str(n) ',fms' num2str(n) ',5,13,''gauss'',0.01);']);
    eval(['[predicty_gauss_tr' num2str(n) ', predict_gauss_tr' num2str(n) '] = testKFMCP3(gauss_tr' num2str(n) ',boundary, tr' num2str(n) ',tr' num2str(n) ',''gauss'',0.01);']);
    outputtable(2*n,1) = {['predict_linear_tr' num2str(n)]};
    outputtable(2*n,2:19) = num2cell(eval(['predict_gauss_tr' num2str(n) '(:,1:18)']));
    eval(['[predicty_gauss_ts' num2str(n) ', predict_gauss_ts' num2str(n) '] = testKFMCP3(gauss_tr' num2str(n) ',boundary, tr' num2str(n) ',testset,''gauss'',0.01);']);
    outputtable(2*n+1,1) = {['predict_gauss_ts' num2str(n)]};
    outputtable(2*n+1,2:19) = num2cell(eval(['predict_gauss_ts' num2str(n) '(:,1:18)']));
end
...
for n=1:5
    eval(['[sigm_tr' num2str(n) ', boundary, alpha_tr' num2str(n) ', beta_tr' num2str(n) '] = trainKFMCP3(tr' num2str(n) ',fms' num2str(n) ',5,13,''sigm'',[0.001,-0.0001]);']);
    eval(['[predicty_sigm_tr' num2str(n) ', predict_sigm_tr' num2str(n) '] = testKFMCP3(sigm_tr' num2str(n) ',boundary, tr' num2str(n) ',tr' num2str(n) ',''sigm'',[0.001,-0.0001]);']);
    outputtable(2*n,1) = {['predict_linear_tr' num2str(n)]};
    outputtable(2*n,2:19) = num2cell(eval(['predict_sigm_tr' num2str(n) '(:,1:18)']));
    eval(['[predicty_sigm_ts' num2str(n) ', predict_sigm_ts' num2str(n) '] = testKFMCP3(sigm_tr' num2str(n) ',boundary, tr' num2str(n) ',testset,''sigm'',[0.001,-0.0001]);']);
    outputtable(2*n+1,1) = {['predict_sigm_ts' num2str(n)]};
    outputtable(2*n+1,2:19) = num2cell(eval(['predict_sigm_ts' num2str(n) '(:,1:18)']));
end
...
for n=1:1:8
    for m=1:1:8
        [linear_tr, boundary, alpha_tr, beta_tr] = trainKFMCP3(tr,fms,C2(n),C2(m),'linear',[]);
        [predicty_linear_ts, predict_linear_ts] = testKFMCP3(linear_tr,boundary, tr,testset,'linear',[]); 
...
for n=1:1:7
    for m=1:1:7
        [poly_tr, boundary, alpha_tr, beta_tr] = trainKFMCP3(tr,fms,C2(n),C2(m),'poly',polykp);
        [predicty_poly_ts, predict_poly_ts] = testKFMCP3(poly_tr,boundary, tr,testset,'poly',polykp); 
        outputtable((m+1)+(n-1)*7,1) = {m+(n-1)*7};
...
for n=1:1:7
    for m=1:1:7
        [gauss_tr, boundary, alpha_tr, beta_tr] = trainKFMCP3(tr,fms,C2(n),C2(m),'gauss',gausskp);
        [predicty_gauss_ts, predict_gauss_ts] = testKFMCP3(gauss_tr,boundary, tr,testset,'gauss',gausskp); 
        outputtable((m+1)+(n-1)*7,1) = {m+(n-1)*7};
...
for n=1:1:7
    for m=1:1:7
        [sigm_tr, boundary, alpha_tr, beta_tr] = trainKFMCP3(tr,fms,C2(n),C2(m),'sigm',sigmkp);
        [predicty_sigm_ts, predict_sigm_ts] = testKFMCP3(sigm_tr,boundary, tr,testset,'sigm',sigmkp); 
        outputtable((m+1)+(n-1)*7,1) = {m+(n-1)*7};
...
for n=1:1:7
    for m=1:1:7
        [linear_tr, boundary, alpha_tr, beta_tr] = trainKFMCP3(tr,fms,C1(n),C1(m),'linear',[]);
        [predicty_linear_ts, predict_linear_ts] = testKFMCP3(linear_tr,boundary, tr,testset,C1(n),C1(m),'linear',[]); 
        outputtable((m+1)+(n-1)*7,1) = {m+(n-1)*7};
        outputtable((m+1)+(n-1)*7,2:19) = num2cell(predict_linear_ts(:,1:18));
    end
end
...
for n=1:1:7
    for m=1:1:7
        [poly_tr, boundary, alpha_tr, beta_tr] = trainKFMCP3(tr,fms,C1(n),C1(m),'poly',[1,2]);
        [predicty_poly_ts, predict_poly_ts] = testKFMCP3(poly_tr,boundary, tr,testset,C1(n),C1(m),'poly',[1,2]); 
        outputtable((m+1)+(n-1)*7,1) = {m+(n-1)*7};
        outputtable((m+1)+(n-1)*7,2:19) = num2cell(predict_poly_ts(:,1:18));
    end
end
...
for n=1:1:7
    for m=1:1:7
        [gauss_tr, boundary, alpha_tr, beta_tr] = trainKFMCP3(tr,fms,C1(n),C1(m),'gauss',0.01);
        [predicty_gauss_ts, predict_gauss_ts] = testKFMCP3(gauss_tr,boundary, tr,testset,C1(n),C1(m),'gauss',0.01); 
        outputtable((m+1)+(n-1)*7,1) = {m+(n-1)*7};
        outputtable((m+1)+(n-1)*7,2:19) = num2cell(predict_gauss_ts(:,1:18));
    end
end
...
for n=1:1:7
    for m=1:1:7
        [sigm_tr, boundary, alpha_tr, beta_tr] = trainKFMCP3(tr,fms,C1(n),C1(m),'sigm',[0.01,-0.001]);
        [predicty_sigm_ts, predict_sigm_ts] = testKFMCP3(sigm_tr,boundary, tr,testset,C1(n),C1(m),'sigm',[0.01,-0.001]); 
        outputtable((m+1)+(n-1)*7,1) = {m+(n-1)*7};
        outputtable((m+1)+(n-1)*7,2:19) = num2cell(predict_sigm_ts(:,1:18));
    end
end
...
for n=1:10
     eval(['[linear_tr' num2str(n) ', boundary, alpha_tr' num2str(n) ', beta_tr' num2str(n) '] = trainKFMCP3(tr,fms,C1(n),C1(10-n+1),''linear'',[]);']);
     eval(['[predicty_linear_ts' num2str(n) ', predict_linear_ts' num2str(n) '] = testKFMCP3(linear_tr' num2str(n) ',boundary, tr,testset,''linear'',[]);']);
     outputtable((n+1),1) = {n};
...
for n=1:1:12
    for m=1:1:12
        [linear_tr, boundary, alpha_tr, beta_tr] = trainKFMCP3(tr,fms,C3(n),C3(m),'linear',[]);
        [predicty_linear_ts, predict_linear_ts] = testKFMCP3(linear_tr,boundary, tr,testset,'linear',[]); 
...
for n=1:1:12
    for m=1:1:12
        [poly_tr, boundary, alpha_tr, beta_tr] = trainKFMCP3(tr,fms,C3(n),C3(m),'poly',polykp);
        [predicty_poly_ts, predict_poly_ts] = testKFMCP3(poly_tr,boundary, tr,testset,'poly',polykp); 
        outputtable((m+1)+(n-1)*12,1) = {m+(n-1)*12};
...
for n=1:1:8
    for m=1:1:8
        [gauss_tr, boundary, , beta_tr] = trainKFMCP3(tr,fms,C2(n),C2(m),'gauss',gausskp);
        [predicty_gauss_ts, predict_gauss_ts] = testKFMCP3(gauss_tr,boundary, tr,testset,'gauss',gausskp); 
        outputtable((m+1)+(n-1)*7,1) = {m+(n-1)*7};
        outputtable((m+1)+(n-1)*7,2:19) = num2cell(predict_gauss_ts(:,1:18));
    end
...
for n=1:1:12
    for m=1:1:12
        [gauss_tr, boundary, alpha_tr, beta_tr] = trainKFMCP3(tr,fms,C3(n),C3(m),'gauss',gausskp);
        [predicty_gauss_ts, predict_gauss_ts] = testKFMCP3(gauss_tr,boundary, tr,testset,'gauss',gausskp); 
        outputtable((m+1)+(n-1)*12,1) = {m+(n-1)*12};
...
for n=1:1:12
    for m=1:1:12
        [sigm_tr, boundary, alpha_tr, beta_tr] = trainKFMCP3(tr,fms,C3(n),C3(m),'sigm',sigmkp);
        [predicty_sigm_ts, predict_sigm_ts] = testKFMCP3(sigm_tr,boundary, tr,testset,'sigm',sigmkp); 
        outputtable((m+1)+(n-1)*12,1) = {m+(n-1)*12};
