...
%stratify sampling: good to bad = 307:383 = 4:5
[trainset,testset] = partition(aus14std,200,250);
...
%----250+250----------%
trainset = aus14std_tr1;
testset = aus14std_ts1;

trainset = ger24std_tr1;
testset = ger24std_ts1;

trainset = usa66std_tr1;
testset = usa66std_ts1;
...
for n=1:10
    eval(['[linear_tr' num2str(n) ', alpha_tr' num2str(n) ', beta_tr' num2str(n) '] = trainKFMCP(tr' num2str(n) ',fms' num2str(n) ',C1,C2,''linear'',[]);']);
    eval(['[predicty_linear_tr' num2str(n) ', predict_linear_tr' num2str(n) '] = testKFMCP(linear_tr' num2str(n) ',tr' num2str(n) ',tr' num2str(n) ',''linear'',[]);']);
    outputtable(2*n,1) = {['predict_linear_tr' num2str(n)]};
    outputtable(2*n,2:19) = num2cell(eval(['predict_linear_tr' num2str(n) '(:,1:18)']));
    eval(['[predicty_linear_ts' num2str(n) ', predict_linear_ts' num2str(n) '] = testKFMCP(linear_tr' num2str(n) ',tr' num2str(n) ',testset,''linear'',[]);']);
    outputtable(2*n+1,1) = {['predict_linear_ts' num2str(n)]};
    outputtable(2*n+1,2:19) = num2cell(eval(['predict_linear_ts' num2str(n) '(:,1:18)']));
end

xlswrite('D:\KFMCPwithMatlab2\results20121025\outputKFMCPforAus14.xls',outputtable,'sheet1','A1');

%output the prediced y for computing H Gini KS and AUC AUCH and so on
for n=1:10
    eval(['csvwrite(''D:\KFMCPwithMatlab2\results20121025\outputKFMCPforAus14-py-linear' num2str(n) '.csv'', predicty_linear_ts' num2str(n) ');']);
end
...
for n=1:10
    eval(['[poly_tr' num2str(n) ', alpha_tr' num2str(n) ', beta_tr' num2str(n) '] = trainKFMCP(tr' num2str(n) ',fms' num2str(n) ',C1,C2,''poly'',polykp);']);
    eval(['[predicty_poly_tr' num2str(n) ', predict_poly_tr' num2str(n) '] = testKFMCP(poly_tr' num2str(n) ',tr' num2str(n) ',tr' num2str(n) ',''poly'',polykp);']);
    outputtable(2*n,1) = {['predict_poly_tr' num2str(n)]};
    outputtable(2*n,2:19) = num2cell(eval(['predict_poly_tr' num2str(n) '(:,1:18)']));
    eval(['[predicty_poly_ts' num2str(n) ', predict_poly_ts' num2str(n) '] = testKFMCP(poly_tr' num2str(n) ',tr' num2str(n) ',testset,''poly'',polykp);']);
    outputtable(2*n+1,1) = {['predict_poly_ts' num2str(n)]};
    outputtable(2*n+1,2:19) = num2cell(eval(['predict_poly_ts' num2str(n) '(:,1:18)']));
end

xlswrite('D:\KFMCPwithMatlab2\results20120123\outputKFMCPforGer24new.xls',outputtable,'sheet2','A1');
...
for n=1:10
    eval(['[gauss_tr' num2str(n) ', alpha_tr' num2str(n) ', beta_tr' num2str(n) '] = trainKFMCP(tr' num2str(n) ',fms' num2str(n) ',C1,C2,''gauss'',gausskp);']);
    eval(['[predicty_gauss_tr' num2str(n) ', predict_gauss_tr' num2str(n) '] = testKFMCP(gauss_tr' num2str(n) ',tr' num2str(n) ',tr' num2str(n) ',''gauss'',gausskp);']);
    outputtable(2*n,1) = {['predict_gauss_tr' num2str(n)]};
    outputtable(2*n,2:19) = num2cell(eval(['predict_gauss_tr' num2str(n) '(:,1:18)']));
    eval(['[predicty_gauss_ts' num2str(n) ', predict_gauss_ts' num2str(n) '] = testKFMCP(gauss_tr' num2str(n) ',tr' num2str(n) ',testset,''gauss'',gausskp);']);
    outputtable(2*n+1,1) = {['predict_gauss_ts' num2str(n)]};
    outputtable(2*n+1,2:19) = num2cell(eval(['predict_gauss_ts' num2str(n) '(:,1:18)']));
end

xlswrite('D:\KFMCPwithMatlab2\results20120123\outputKFMCPforGer24new.xls',outputtable,'sheet3','A13');
...
for n=1:10
    eval(['[sigm_tr' num2str(n) ', alpha_tr' num2str(n) ', beta_tr' num2str(n) '] = trainKFMCP(tr' num2str(n) ',fms' num2str(n) ',C1,C2,''sigm'',sigmkp);']);
    eval(['[predicty_sigm_tr' num2str(n) ', predict_sigm_tr' num2str(n) '] = testKFMCP(sigm_tr' num2str(n) ',tr' num2str(n) ',tr' num2str(n) ',''sigm'',sigmkp);']);
    outputtable(2*n,1) = {['predict_sigm_tr' num2str(n)]};
    outputtable(2*n,2:19) = num2cell(eval(['predict_sigm_tr' num2str(n) '(:,1:18)']));
    eval(['[predicty_sigm_ts' num2str(n) ', predict_sigm_ts' num2str(n) '] = testKFMCP(sigm_tr' num2str(n) ',tr' num2str(n) ',testset,''sigm'',sigmkp);']);
    outputtable(2*n+1,1) = {['predict_sigm_ts' num2str(n)]};
    outputtable(2*n+1,2:19) = num2cell(eval(['predict_sigm_ts' num2str(n) '(:,1:18)']));
end

xlswrite('D:\KFMCPwithMatlab2\results20120123\outputKFMCPforGer24new.xls',outputtable,'sheet4','A1');
...
for n=1:5
    eval(['[linear_tr' num2str(n) ', alpha_tr' num2str(n) ', beta_tr' num2str(n) '] = trainKFMCP(tr' num2str(n) ',fms' num2str(n) ',5,13,''linear'',[]);']);
    eval(['[predicty_linear_tr' num2str(n) ', predict_linear_tr' num2str(n) '] = testKFMCP(linear_tr' num2str(n) ',tr' num2str(n) ',tr' num2str(n) ',''linear'',[]);']);
    outputtable(2*n,1) = {['predict_linear_tr' num2str(n)]};
    outputtable(2*n,2:19) = num2cell(eval(['predict_linear_tr' num2str(n) '(:,1:18)']));
    eval(['[predicty_linear_ts' num2str(n) ', predict_linear_ts' num2str(n) '] = testKFMCP(linear_tr' num2str(n) ',tr' num2str(n) ',testset,''linear'',[]);']);
...
for n=1:5
    eval(['[poly_tr' num2str(n) ', alpha_tr' num2str(n) ', beta_tr' num2str(n) '] = trainKFMCP(tr' num2str(n) ',fms' num2str(n) ',5,13,''poly'',[1,2]);']);
    eval(['[predicty_poly_tr' num2str(n) ', predict_poly_tr' num2str(n) '] = testKFMCP(poly_tr' num2str(n) ',tr' num2str(n) ',tr' num2str(n) ',''poly'',[1,2]);']);
    outputtable(2*n,1) = {['predict_linear_tr' num2str(n)]};
    outputtable(2*n,2:19) = num2cell(eval(['predict_poly_tr' num2str(n) '(:,1:18)']));
    eval(['[predicty_poly_ts' num2str(n) ', predict_poly_ts' num2str(n) '] = testKFMCP(poly_tr' num2str(n) ',tr' num2str(n) ',testset,''poly'',[1,2]);']);
    outputtable(2*n+1,1) = {['predict_poly_ts' num2str(n)]};
    outputtable(2*n+1,2:19) = num2cell(eval(['predict_poly_ts' num2str(n) '(:,1:18)']));
end
...
for n=1:5
    eval(['[gauss_tr' num2str(n) ', alpha_tr' num2str(n) ', beta_tr' num2str(n) '] = trainKFMCP(tr' num2str(n) ',fms' num2str(n) ',5,13,''gauss'',0.01);']);
    eval(['[predicty_gauss_tr' num2str(n) ', predict_gauss_tr' num2str(n) '] = testKFMCP(gauss_tr' num2str(n) ',tr' num2str(n) ',tr' num2str(n) ',''gauss'',0.01);']);
    outputtable(2*n,1) = {['predict_linear_tr' num2str(n)]};
    outputtable(2*n,2:19) = num2cell(eval(['predict_gauss_tr' num2str(n) '(:,1:18)']));
    eval(['[predicty_gauss_ts' num2str(n) ', predict_gauss_ts' num2str(n) '] = testKFMCP(gauss_tr' num2str(n) ',tr' num2str(n) ',testset,''gauss'',0.01);']);
    outputtable(2*n+1,1) = {['predict_gauss_ts' num2str(n)]};
    outputtable(2*n+1,2:19) = num2cell(eval(['predict_gauss_ts' num2str(n) '(:,1:18)']));
end
...
for n=1:5
    eval(['[sigm_tr' num2str(n) ', alpha_tr' num2str(n) ', beta_tr' num2str(n) '] = trainKFMCP(tr' num2str(n) ',fms' num2str(n) ',5,13,''sigm'',[0.001,-0.0001]);']);
    eval(['[predicty_sigm_tr' num2str(n) ', predict_sigm_tr' num2str(n) '] = testKFMCP(sigm_tr' num2str(n) ',tr' num2str(n) ',tr' num2str(n) ',''sigm'',[0.001,-0.0001]);']);
    outputtable(2*n,1) = {['predict_linear_tr' num2str(n)]};
    outputtable(2*n,2:19) = num2cell(eval(['predict_sigm_tr' num2str(n) '(:,1:18)']));
    eval(['[predicty_sigm_ts' num2str(n) ', predict_sigm_ts' num2str(n) '] = testKFMCP(sigm_tr' num2str(n) ',tr' num2str(n) ',testset,''sigm'',[0.001,-0.0001]);']);
    outputtable(2*n+1,1) = {['predict_sigm_ts' num2str(n)]};
    outputtable(2*n+1,2:19) = num2cell(eval(['predict_sigm_ts' num2str(n) '(:,1:18)']));
end
...
for n=1:1:8
    for m=1:1:8
        [linear_tr, alpha_tr, beta_tr] = trainKFMCP(tr,fms,C2(n),C2(m),'linear',[]);
        [predicty_linear_ts, predict_linear_ts] = testKFMCP(linear_tr,tr,testset,'linear',[]); 
...
for n=1:1:7
    for m=1:1:7
        poly_tr, alpha_tr, beta_tr] = trainKFMCP(tr,fms,C2(n),C2(m),'poly',polykp);
        [predicty_poly_ts, predict_poly_ts] = testKFMCP(poly_tr,tr,testset,'poly',polykp); 
        outputtable((m+1)+(n-1)*7,1) = {m+(n-1)*7};
...
for n=1:1:7
    for m=1:1:7
        gauss_tr, alpha_tr, beta_tr] = trainKFMCP(tr,fms,C2(n),C2(m),'gauss',gausskp);
        [predicty_gauss_ts, predict_gauss_ts] = testKFMCP(gauss_tr,tr,testset,'gauss',gausskp); 
        outputtable((m+1)+(n-1)*7,1) = {m+(n-1)*7};
...
for n=1:1:7
    for m=1:1:7
        sigm_tr, alpha_tr, beta_tr] = trainKFMCP(tr,fms,C2(n),C2(m),'sigm',sigmkp);
        [predicty_sigm_ts, predict_sigm_ts] = testKFMCP(sigm_tr,tr,testset,'sigm',sigmkp); 
        outputtable((m+1)+(n-1)*7,1) = {m+(n-1)*7};
...
for n=1:1:7
    for m=1:1:7
        linear_tr, alpha_tr, beta_tr] = trainKFMCP(tr,fms,C1(n),C1(m),'linear',[]);
        [predicty_linear_ts, predict_linear_ts] = testKFMCP(linear_tr,tr,testset,C1(n),C1(m),'linear',[]); 
        outputtable((m+1)+(n-1)*7,1) = {m+(n-1)*7};
        outputtable((m+1)+(n-1)*7,2:19) = num2cell(predict_linear_ts(:,1:18));
    end
end
...
for n=1:1:7
    for m=1:1:7
        poly_tr, alpha_tr, beta_tr] = trainKFMCP(tr,fms,C1(n),C1(m),'poly',[1,2]);
        [predicty_poly_ts, predict_poly_ts] = testKFMCP(poly_tr,tr,testset,C1(n),C1(m),'poly',[1,2]); 
        outputtable((m+1)+(n-1)*7,1) = {m+(n-1)*7};
        outputtable((m+1)+(n-1)*7,2:19) = num2cell(predict_poly_ts(:,1:18));
    end
end
...
for n=1:1:7
    for m=1:1:7
        gauss_tr, alpha_tr, beta_tr] = trainKFMCP(tr,fms,C1(n),C1(m),'gauss',0.01);
        [predicty_gauss_ts, predict_gauss_ts] = testKFMCP(gauss_tr,tr,testset,C1(n),C1(m),'gauss',0.01); 
        outputtable((m+1)+(n-1)*7,1) = {m+(n-1)*7};
        outputtable((m+1)+(n-1)*7,2:19) = num2cell(predict_gauss_ts(:,1:18));
    end
end
...
for n=1:1:7
    for m=1:1:7
        sigm_tr, alpha_tr, beta_tr] = trainKFMCP(tr,fms,C1(n),C1(m),'sigm',[0.01,-0.001]);
        [predicty_sigm_ts, predict_sigm_ts] = testKFMCP(sigm_tr,tr,testset,C1(n),C1(m),'sigm',[0.01,-0.001]); 
        outputtable((m+1)+(n-1)*7,1) = {m+(n-1)*7};
        outputtable((m+1)+(n-1)*7,2:19) = num2cell(predict_sigm_ts(:,1:18));
    end
end
...
C2 = [10,20,50,100,200,500,1000,2000];
C3 = [10,20,30,50,70,90,100,200,500,1000];
...
fmst = computeFuzzynumber(trainset,0.001,'linear',[]);
cleanset = deleteoutliers(trainset,fmst,0.001);
ncol = size(cleanset,2);
tr = cleanset(:,1:ncol-1);
fms = cleanset(:,ncol);
...
for n=1:10
     eval(['[linear_tr' num2str(n) ', alpha_tr' num2str(n) ', beta_tr' num2str(n) '] = trainKFMCP(tr,fms,C3(n),C3(10-n+1),''linear'',[]);']);
     eval(['[predicty_linear_ts' num2str(n) ', predict_linear_ts' num2str(n) '] = testKFMCP(linear_tr' num2str(n) ',tr,testset,''linear'',[]);']);
     outputtable((n+1),1) = {n};
     outputtable((n+1),2:19) = num2cell(eval(['predict_linear_ts' num2str(n) '(:,1:18)']));
end

xlswrite('D:\KFMCPwithMatlab2\results20120123\outputKFMCPforSPAus1402.xls',outputtable,'sheet1','A1');
...
for n=1:1:12
    for m=1:1:12
        [linear_tr, alpha_tr, beta_tr] = trainKFMCP(tr,fms,C3(n),C3(m),'linear',[]);
        [predicty_linear_ts, predict_linear_ts] = testKFMCP(linear_tr,tr,testset,'linear',[]); 
...
for n=1:1:12
    for m=1:1:12
        [poly_tr, alpha_tr, beta_tr] = trainKFMCP(tr,fms,C3(n),C3(m),'poly',polykp);
        [predicty_poly_ts, predict_poly_ts] = testKFMCP(poly_tr,tr,testset,'poly',polykp); 
        outputtable((m+1)+(n-1)*12,1) = {m+(n-1)*12};
...
for n=1:10
    for m=1:10
        [gauss_tr, alpha_tr, beta_tr] = trainKFMCP(tr,fms,C1(n),C1(m),'gauss',gausskp);
        [predicty_gauss_ts, predict_gauss_ts] = testKFMCP(gauss_tr,tr,testset,'gauss',gausskp); 
        outputtable((m+1)+(n-1)*7,1) = {m+(n-1)*7};
        outputtable((m+1)+(n-1)*7,2:19) = num2cell(predict_gauss_ts(:,1:18));
    end
...
xlswrite('D:\KFMCPwithMatlab2\results20120123\outputKFMCPforSPUsa66.xls',outputtable,'sheet3','A1');
...
for n=1:1:12
    for m=1:1:12
        [gauss_tr, alpha_tr, beta_tr] = trainKFMCP(tr,fms,C3(n),C3(m),'gauss',gausskp);
        [predicty_gauss_ts, predict_gauss_ts] = testKFMCP(gauss_tr,tr,testset,'gauss',gausskp); 
        outputtable((m+1)+(n-1)*12,1) = {m+(n-1)*12};
...
for n=1:1:12
    for m=1:1:12
        [sigm_tr, alpha_tr, beta_tr] = trainKFMCP(tr,fms,C3(n),C3(m),'sigm',sigmkp);
        [predicty_sigm_ts, predict_sigm_ts] = testKFMCP(sigm_tr,tr,testset,'sigm',sigmkp); 
        outputtable((m+1)+(n-1)*12,1) = {m+(n-1)*12};
