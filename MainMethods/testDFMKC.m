...
%**********************************************************************************************************%
function [y_pred,acc,cm,precision,recall,f1_score] = testDFMKC(Xtest,ytest,model,net)
...
% (2) ytest = testing target vector, where rows are instances
...
n = net.n;
Ks = Ks(n+1:end,1:n);
[y_pred, acc, ~] = svmpredict(ytest, [(1:r-n)' Ks], model);
